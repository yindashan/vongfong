...
DEFAULT_UPGRADE_SERVER="10.2.161.15"
DEFAULT_UPGRADE_PORT=8090
...
# 1.2 获取agent最新版本号
LATEST_VERSION=`curl --connect-timeout 5 --retry 3 http://$DEFAULT_UPGRADE_SERVER:$DEFAULT_UPGRADE_PORT/version 2> /dev/null`
if [ $? -ne 0 ];then
